...
Evaluates 10 classifiers (Logistic Regression, SVM, Decision Tree, Random Forest, Extra Trees, XGBoost, LightGBM, k-NN, Naive Bayes, MLP) across all datasets using 10-fold stratified cross-validation.
